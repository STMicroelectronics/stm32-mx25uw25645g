...
/** @defgroup MX25UW25645G MX25UW25645G
  * @{
  */
...
int32_t MX25UW25645G_GetFlashInfo(MX25UW25645G_Info_t *pInfo)
{
  ...
  pInfo->FlashSize              = MX25UW25645G_FLASH_SIZE;
  pInfo->EraseSectorSize        = MX25UW25645G_SECTOR_64K;
  pInfo->EraseSectorsNumber     = (MX25UW25645G_FLASH_SIZE / MX25UW25645G_SECTOR_64K);
  pInfo->EraseSubSectorSize     = MX25UW25645G_SUBSECTOR_4K;
  pInfo->EraseSubSectorNumber   = (MX25UW25645G_FLASH_SIZE / MX25UW25645G_SUBSECTOR_4K);
  pInfo->EraseSubSector1Size    = MX25UW25645G_SUBSECTOR_4K;
  pInfo->EraseSubSector1Number  = (MX25UW25645G_FLASH_SIZE / MX25UW25645G_SUBSECTOR_4K);
  pInfo->ProgPageSize           = MX25UW25645G_PAGE_SIZE;
  pInfo->ProgPagesNumber        = (MX25UW25645G_FLASH_SIZE / MX25UW25645G_PAGE_SIZE);

  return MX25UW25645G_OK;
};
                                         ...
                                         MX25UW25645G_Transfer_t Rate)
{
  ...
  if ((Mode == MX25UW25645G_SPI_MODE) && (Rate == MX25UW25645G_DTR_TRANSFER))
  {
    return MX25UW25645G_ERROR;
  }

  /* Configure automatic polling mode to wait for memory ready */
  s_command.OperationType      = HAL_XSPI_OPTYPE_COMMON_CFG;
  s_command.IOSelect           = HAL_XSPI_SELECT_IO_7_0;
  s_command.InstructionMode    = (Mode == MX25UW25645G_SPI_MODE)
                                 ? HAL_XSPI_INSTRUCTION_1_LINE
                                 : HAL_XSPI_INSTRUCTION_8_LINES;
  s_command.InstructionDTRMode = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_INSTRUCTION_DTR_ENABLE
                                 : HAL_XSPI_INSTRUCTION_DTR_DISABLE;
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ? HAL_XSPI_INSTRUCTION_8_BITS
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_READ_STATUS_REG_CMD
                                 : MX25UW25645G_OCTA_READ_STATUS_REG_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
  s_command.AddressWidth        = HAL_XSPI_ADDRESS_32_BITS;
  s_command.Address            = 0U;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_DATA_1_LINE : HAL_XSPI_DATA_8_LINES;
  s_command.DataDTRMode        = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_DATA_DTR_ENABLE
                                 : HAL_XSPI_DATA_DTR_DISABLE;
  s_command.DummyCycles        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? 0U
                                 : ((Rate == MX25UW25645G_DTR_TRANSFER)
                                    ? DUMMY_CYCLES_REG_OCTAL_DTR
                                    : DUMMY_CYCLES_REG_OCTAL);
  s_command.DataLength             = (Rate == MX25UW25645G_DTR_TRANSFER) ? 2U : 1U;
  s_command.DQSMode            = (Rate == MX25UW25645G_DTR_TRANSFER) ? HAL_XSPI_DQS_ENABLE : HAL_XSPI_DQS_DISABLE;
#if defined (XSPI_CCR_SIOO)
  s_command.SIOOMode            = HAL_XSPI_SIOO_INST_EVERY_CMD;
#endif

  s_config.MatchValue         = 0U;
  s_config.MatchMask          = MX25UW25645G_SR_WIP;
  s_config.MatchMode          = HAL_XSPI_MATCH_MODE_AND;
  s_config.IntervalTime      = MX25UW25645G_AUTOPOLLING_INTERVAL_TIME;
                             ...
                             MX25UW25645G_AddressSize_t AddressSize, uint8_t *pData, uint32_t ReadAddr, uint32_t Size)
{
  ...
  if ((Mode == MX25UW25645G_OPI_MODE) && (AddressSize == MX25UW25645G_3BYTES_SIZE))
  {
    return MX25UW25645G_ERROR;
  }
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? ((AddressSize == MX25UW25645G_3BYTES_SIZE)
                                    ? MX25UW25645G_FAST_READ_CMD
                                    : MX25UW25645G_4_BYTE_ADDR_FAST_READ_CMD)
                                 : MX25UW25645G_OCTA_READ_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? HAL_XSPI_ADDRESS_1_LINE
                                 : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = HAL_XSPI_ADDRESS_DTR_DISABLE;
  s_command.AddressWidth        = (AddressSize == MX25UW25645G_3BYTES_SIZE)
  ...
  s_command.DummyCycles        = (Mode == MX25UW25645G_SPI_MODE) ? DUMMY_CYCLES_READ : DUMMY_CYCLES_READ_OCTAL;
...
int32_t MX25UW25645G_ReadDTR(XSPI_HandleTypeDef *Ctx, uint8_t *pData, uint32_t ReadAddr, uint32_t Size)
{
  ...
  s_command.Instruction        = MX25UW25645G_OCTA_READ_DTR_CMD;
...
/**
  ...
  * @param  Size Size of data to write. Range 1 ~ MX25UW25645G_PAGE_SIZE
                                 ...
                                 uint32_t Size)
{
  ...
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? ((AddressSize == MX25UW25645G_3BYTES_SIZE)
                                    ? MX25UW25645G_PAGE_PROG_CMD
                                    : MX25UW25645G_4_BYTE_PAGE_PROG_CMD)
                                 : MX25UW25645G_OCTA_PAGE_PROG_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? HAL_XSPI_ADDRESS_1_LINE
                                 : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = HAL_XSPI_ADDRESS_DTR_DISABLE;
...
int32_t MX25UW25645G_PageProgramDTR(XSPI_HandleTypeDef *Ctx, uint8_t *pData, uint32_t WriteAddr, uint32_t Size)
{
  ...
  s_command.InstructionDTRMode = HAL_XSPI_INSTRUCTION_DTR_ENABLE;
  s_command.InstructionWidth    = HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = MX25UW25645G_OCTA_PAGE_PROG_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = HAL_XSPI_ADDRESS_DTR_ENABLE;
  s_command.AddressWidth        = HAL_XSPI_ADDRESS_32_BITS;
  s_command.Address            = WriteAddr;
...
/**
  ...
  *         MX25UW25645G support 4K, 64K size block erase commands.
  *         SPI/OPI; 1-1-1/8-8-8
  * @param  Ctx Component object pointer
  * @param  Mode Interface mode
                                ...
                                MX25UW25645G_Erase_t BlockSize)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ? HAL_XSPI_INSTRUCTION_8_BITS
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_ADDRESS_1_LINE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
  s_command.AddressWidth        = (AddressSize == MX25UW25645G_3BYTES_SIZE)
  ...
  switch (Mode)
  {
    case MX25UW25645G_OPI_MODE :
      if (BlockSize == MX25UW25645G_ERASE_64K)
      {
        s_command.Instruction = MX25UW25645G_OCTA_SECTOR_ERASE_64K_CMD;
      }
      else
      {
        s_command.Instruction = MX25UW25645G_OCTA_SUBSECTOR_ERASE_4K_CMD;
      }
      break;

    case MX25UW25645G_SPI_MODE :
    default:
      if (BlockSize == MX25UW25645G_ERASE_64K)
      {
        s_command.Instruction = (AddressSize == MX25UW25645G_3BYTES_SIZE)
                                ? MX25UW25645G_SECTOR_ERASE_64K_CMD
                                : MX25UW25645G_4_BYTE_SECTOR_ERASE_64K_CMD;
      }
      else
      {
        s_command.Instruction = (AddressSize == MX25UW25645G_3BYTES_SIZE)
                                ? MX25UW25645G_SUBSECTOR_ERASE_4K_CMD
                                : MX25UW25645G_4_BYTE_SUBSECTOR_ERASE_4K_CMD;
      }
      break;
  }
...
int32_t MX25UW25645G_ChipErase(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_BULK_ERASE_CMD
                                 : MX25UW25645G_OCTA_BULK_ERASE_CMD;
...
int32_t MX25UW25645G_Suspend(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_PROG_ERASE_SUSPEND_CMD
                                 : MX25UW25645G_OCTA_PROG_ERASE_SUSPEND_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
...
int32_t MX25UW25645G_Resume(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_PROG_ERASE_RESUME_CMD
                                 : MX25UW25645G_OCTA_PROG_ERASE_RESUME_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
...
int32_t MX25UW25645G_WriteEnable(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_WRITE_ENABLE_CMD
                                 : MX25UW25645G_OCTA_WRITE_ENABLE_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
  ...
  s_command.Address        = 0U;
  s_command.DataMode       = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_DATA_1_LINE : HAL_XSPI_DATA_8_LINES;
  s_command.DataDTRMode    = (Rate == MX25UW25645G_DTR_TRANSFER) ? HAL_XSPI_DATA_DTR_ENABLE : HAL_XSPI_DATA_DTR_DISABLE;
  s_command.DummyCycles    = (Mode == MX25UW25645G_SPI_MODE)
                             ? 0U
                             : ((Rate == MX25UW25645G_DTR_TRANSFER)
                                ? DUMMY_CYCLES_REG_OCTAL_DTR
...
int32_t MX25UW25645G_WriteDisable(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_WRITE_DISABLE_CMD
                                 : MX25UW25645G_OCTA_WRITE_DISABLE_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
                                         ...
                                         MX25UW25645G_Transfer_t Rate, uint8_t Value)
{
  ...
  if (Mode == MX25UW25645G_SPI_MODE)
  {
    if (MX25UW25645G_ReadCfgRegister(Ctx, Mode, Rate, &reg[1]) != MX25UW25645G_OK)
    {
      return MX25UW25645G_ERROR;
    }
  }
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_WRITE_STATUS_REG_CMD
                                 : MX25UW25645G_OCTA_WRITE_STATUS_REG_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
  ...
  s_command.DataDTRMode        = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ...
                                 : HAL_XSPI_DATA_DTR_DISABLE;
  s_command.DummyCycles        = 0U;
  s_command.DataLength             = (Mode == MX25UW25645G_SPI_MODE) ? 2U : ((Rate == MX25UW25645G_DTR_TRANSFER) ? 2U : 1U);
  s_command.DQSMode            = HAL_XSPI_DQS_DISABLE;
#if defined (XSPI_CCR_SIOO)
  s_command.SIOOMode            = HAL_XSPI_SIOO_INST_EVERY_CMD;
#endif
                                      ...
                                      MX25UW25645G_Transfer_t Rate, uint8_t Value)
{
  ...
  if (Mode == MX25UW25645G_SPI_MODE)
  {
    if (MX25UW25645G_ReadStatusRegister(Ctx, Mode, Rate, &reg[0]) != MX25UW25645G_OK)
    {
      return MX25UW25645G_ERROR;
    }
    reg[1] = Value;
                                     ...
                                     MX25UW25645G_Transfer_t Rate, uint8_t *Value)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_READ_CFG_REG_CMD
                                 : MX25UW25645G_OCTA_READ_CFG_REG_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
                                       ...
                                       MX25UW25645G_Transfer_t Rate, uint32_t WriteAddr, uint8_t Value)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_WRITE_CFG_REG2_CMD
                                 : MX25UW25645G_OCTA_WRITE_CFG_REG2_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_ADDRESS_1_LINE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
  ...
  s_command.DataDTRMode        = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ...
                                 : HAL_XSPI_DATA_DTR_DISABLE;
  s_command.DummyCycles        = 0U;
  s_command.DataLength             = (Mode == MX25UW25645G_SPI_MODE) ? 1U : ((Rate == MX25UW25645G_DTR_TRANSFER) ? 2U : 1U);
  s_command.DQSMode            = HAL_XSPI_DQS_DISABLE;
#if defined (XSPI_CCR_SIOO)
  s_command.SIOOMode            = HAL_XSPI_SIOO_INST_EVERY_CMD;
#endif
                                      ...
                                      MX25UW25645G_Transfer_t Rate, uint32_t ReadAddr, uint8_t *Value)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_READ_CFG_REG2_CMD
                                 : MX25UW25645G_OCTA_READ_CFG_REG2_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_ADDRESS_1_LINE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
                                           ...
                                           MX25UW25645G_Transfer_t Rate, uint8_t Value)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_WRITE_SECURITY_REG_CMD
                                 : MX25UW25645G_OCTA_WRITE_SECURITY_REG_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
                                          ...
                                          MX25UW25645G_Transfer_t Rate, uint8_t *Value)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_READ_SECURITY_REG_CMD
                                 : MX25UW25645G_OCTA_READ_SECURITY_REG_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UW25645G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
                            ...
                            uint8_t *ID)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_READ_ID_CMD
                                 : MX25UW25645G_OCTA_READ_ID_CMD;
  s_command.AddressMode        = (Mode == MX25UW25645G_SPI_MODE)
...
int32_t MX25UW25645G_ResetEnable(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_RESET_ENABLE_CMD
                                 : MX25UW25645G_OCTA_RESET_ENABLE_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
...
int32_t MX25UW25645G_ResetMemory(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_RESET_MEMORY_CMD
                                 : MX25UW25645G_OCTA_RESET_MEMORY_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
...
int32_t MX25UW25645G_NoOperation(XSPI_HandleTypeDef *Ctx, MX25UW25645G_Interface_t Mode, MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ? HAL_XSPI_INSTRUCTION_8_BITS
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE) ? MX25UW25645G_NOP_CMD : MX25UW25645G_OCTA_NOP_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
                                    ...
                                    MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_ENTER_DEEP_POWER_DOWN_CMD
                                 : MX25UW25645G_OCTA_ENTER_DEEP_POWER_DOWN_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
                                          ...
                                          MX25UW25645G_Transfer_t Rate)
{
  ...
  s_command.InstructionWidth    = (Mode == MX25UW25645G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UW25645G_SPI_MODE)
                                 ? MX25UW25645G_RELEASE_FROM_DEEP_POWER_DOWN_CMD
                                 : MX25UW25645G_OCTA_RELEASE_FROM_DEEP_POWER_DOWN_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
